...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/AG-SEK/nomad-oasis-perolab-umr-image-v2.git
    cd nomad-oasis-perolab-umr-image-v2
    ```

    or

    ```sh
    curl-L -o nomad-oasis-perolab-umr-image-v2.zip "https://github.com/AG-SEK/nomad-oasis-perolab-umr-image-v2/archive/main.zip"
    unzip nomad-oasis-perolab-umr-image-v2.zip
    cd nomad-oasis-perolab-umr-image-v2
    ```
...
your `docker-compose.yaml` with `ghcr.io/ag-sek/nomad-oasis-perolab-umr-image-v2:main` for the services
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/AG-SEK/nomad-oasis-perolab-umr-image-v2/manifests/main": unauthorized`
